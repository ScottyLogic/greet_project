...
import { idlFactory } from './greet_canister.did.js';
export { idlFactory } from './greet_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GREET_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./greet_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the greet_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./greet_canister.did.js")._SERVICE>}
 */
export const greet_canister = createActor(canisterId);
